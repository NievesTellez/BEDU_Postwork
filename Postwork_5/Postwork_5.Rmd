...
Con ayuda de la prueba t de student (utilizamos el siguiente comando `?t.test` en *r* para ver la estructura de la función) podemos aceptar o rechazar las hipotesis antes propuestas, en este caso
empleamos 'alternative = "two sided"' dado que el valor de la hipotesis
nula es igual a cero. 
...
R.-  Puesto que el p-value = 0.03567 y este valor es mayor a 0.01 entonces EEE de aceptar la hipotesis nula
...
- Primero realizamos la prueba de varianza para comparar la varianza de las dos muestras
...
R.-* Dado que el valor p-values es aproximadamente cero, se puede rechazar la hipotesis nula, esto es el promedio entre la longitud del petalo no es el mismo para las especies virginica y versicolor, es 1.1 cm más grande.*
